        ...
        <div class="formBox-top">
            <el-form :model="formItem" class="clearFix" inline>
                <el-form-item label="手机号：">
                    <el-input   @keyup.enter.native="refreshHandle" clearable v-model="formItem.phoneNumber" placeholder="请输入手机号"></el-input>
                </el-form-item>
                ...
                <el-form-item class="fr">
                    <el-button  class="yellowBtn"   @click="refreshHandle">查询</el-button>
                    ...
                    <el-form :model="addEdit" :rules="rules" ref="addSynBtn" label-width="150px">
                        <el-form-item label="手机号：" prop="cellPhone">
                            <div class="synbox">
                                ...
                                <el-button class="cyanBtn" @click="synBtn">查询</el-button>
                            </div>
                        </el-form-item>
                    </el-form>
